...
const LoginForm = () => {
  ...
  useEffect(() => {
    if (searchParams.get('expired')) {
      showError('Not logged in or login expired, please log in again!');
    }
          ...
          <Modal.Content>
            <Modal.Description>
              ...
              <div style={{ textAlign: 'center' }}>
                <p>
                  Scan the QR code with WeChat to follow the official account, enter 'verification code' to get the code (valid for 3 minutes)
                </p>
              </div>
              <Form size='large'>
                <Form.Input
