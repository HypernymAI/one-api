...
function renderRole(role) {
  switch (role) {
    ...
    case 10:
      return <Label color='yellow'>Admin</Label>;
    case 100:
      return <Label color='orange'>Super Admin</Label>;
    default:
...
const UsersTable = () => {
  ...
  const renderStatus = (status) => {
    switch (status) {
      case 1:
        return <Label basic>Active</Label>;
      case 2:
        return (
            ...
            .map((user, idx) => {
              ...
              return (
                <Table.Row key={user.id}>
                  ...
                  <Table.Cell>
                    <Popup
                      content={user.email ? user.email : 'No email address bound'}
                      key={user.username}
                  ...
                  {/*</Table.Cell>*/}
                  <Table.Cell>
                    <Popup content='Remaining Balance' trigger={<Label basic>{renderQuota(user.quota)}</Label>} />
                    <Popup content='Used Balance' trigger={<Label basic>{renderQuota(user.used_quota)}</Label>} />
          ...
          <Table.Row>
            <Table.HeaderCell colSpan='7'>
              ...
              <Dropdown
                ...
                selection
                options={[
                  { key: '', text: 'Default Sort', value: '' },
                  { key: 'quota', text: 'Sort by Remaining Balance', value: 'quota' },
                  { key: 'used_quota', text: 'Sort by Used Balance', value: 'used_quota' },
