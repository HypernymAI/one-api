      ...
      <Grid.Column>
        <Form loading={loading}>
          ...
          <Form.Group inline>
            ...
            />
            {
              ...
              >
                ...
                <Modal.Content>
                  <p>Disabling password login will prevent all users (including administrators) who have not bound other login methods from logging in with a password. Are you sure you want to continue?</p>
                </Modal.Content>
                <Modal.Actions>
            ...
            <Form.Checkbox
              ...
              label='Allow login & registration with WeChat'
          ...
          <Header as='h3'>
            ...
            <Header.Subheader>Used to prevent malicious users from registering in bulk with temporary emails</Header.Subheader>
          </Header>
          <Form.Group widths={3}>
            <Form.Checkbox
          ...
          <Form.Group widths={3}>
            ...
            <Form.Input
              ...
              autoComplete='new-password'
              checked={inputs.RegisterEnabled === 'true'}
              placeholder='Sensitive information will not be displayed on the frontend'
            />
          </Form.Group>
          ...
          <Divider />
          <Header as='h3'>
            Configure Lark Authorization Login
            <Header.Subheader>
              Used to support login and registration through Lark,
              <a href='https://open.feishu.cn/app' target='_blank'>
                click here
              </a>
              to manage your Lark application
            </Header.Subheader>
          </Header>
          <Message>
            Homepage Link: <code>{inputs.ServerAddress}</code>
            , Redirect URL:{' '}
          ...
          <Header as='h3'>
            ...
            <Header.Subheader>
              ...
              to manage your Turnstile Sites, Invisible Widget Type is recommended
            </Header.Subheader>
          </Header>
          <Form.Group widths={3}>
            <Form.Input
